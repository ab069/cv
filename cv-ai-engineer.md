...
- **Cloud:** AWS (EC2, S3), Supabase, CI/CD, Docker
...
- Architected scalable microservices (NestJS, TypeORM) with multi-tenant logic, RBAC, and audit logging to support AI-driven workflows.
- Designed high-performance GraphQL gateways unifying data access across distributed services.
- Managed AWS infrastructure (EC2, S3) and CI/CD pipelines, ensuring 99.9% uptime for AI-integrated products.
- Mentored engineers on integrating LLM-based features into production systems.

**Software Engineer (Remote, Contractual)**
Digital Security Network | Jul 2023 – Present
- Enhanced a flight log book application by integrating LLM-based APIs for smart data retrieval and contextual insights, on a Supabase/React/Node.js stack.
