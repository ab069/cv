...
- Built the underlying microservices (NestJS, TypeORM) and GraphQL gateways that automation pipelines run against, with RBAC and audit logging for safe autonomous operation.
- Managed AWS infrastructure and CI/CD pipelines that automated pipelines depend on, maintaining 99.9% uptime.
